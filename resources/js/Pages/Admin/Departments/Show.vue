                          ...
                          <div class="card px-2 py-2">
                            <div class="row bg-color-blue mx-3 mb-4 py-1">
                                <div class="card-header">
                                    <h3 class="card text-center col-lg-12 text-white" style="background-color:#4851ec"><strong>{{ department.name }}</strong></h3>
                                ...
                                <div class="card-body table-responsive p-0">
                                    <table id="myTable" class="table table-striped table-bordered dataTable" cellspacing="0" width="100%" role="grid" aria-describedby="example_info" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th class="text-capitalize">Service intégré</th>
                                                <th class="text-capitalize">Description du service</th>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="card text-center col-lg-11 text-white" style="background-color:#4851ec"><strong>Modifier un service</strong></h3>
                            ...
                            <div class="card card-primary">
                                <form @submit.prevent="editService">
                                    ...
                                    <div class="modal-footer justify-content-between">
                                        ...
                                        <button type="submit" class="btn btn-info btn-style text-white" style="letter-spacing:0.1em; background-color:#4851ec; border-radius:20px;" :disabled="!form.name || !form.description || form.processing">Modifier</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<script>
    ...
    export default {
        props: ['department', 'services', 'services_count'],
        components: {
            AdminLayout,
        },
        data() {
            return {
                ...
                departmentShow: this.department,
