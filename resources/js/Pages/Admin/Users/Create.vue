          ...
          <div class="row">
            <div class="col-12">
              <div class="card px-2 py-2">
                <div class="">
                    <h3 class="card text-center col-lg-12 text-white" style="background-color:#4851ec"><strong>Ajout d'un nouvel utilisateur</strong></h3>
                </div>
...
import axios from 'axios'
    ...
    export default {
        props: ['grades', 'users', 'services', 'users_count'],
        components: {
            AdminLayout,
        },
        data() {
        ...
        methods: {
            ...
            createUser() {
                // axios.post(this.route('admin.users.store'), )
