  ...
  <div>
    <admin-layout>
      <section class="content">
        <div class="container-fluid" v-if="request.user_id === user.id || ( user.grade_id === 5) || (user.grade_id === 4) || (user.grade_id === 3) || (user.grade_id === 2) || (user.grade_id === 7) || (user.grade_id === 8) || (user.grade_id === 9) || (user.grade_id === 10)">
          <div class="row" id="">
            <div class="d-flex">
                ...
                <div class="col-4"></div>
                <div>
                    <div style="float:right; right:-120px" class="col-4">
                    ...
                    <div style="padding:50px">
                        ...
                        <div  v-if="request.request_type_id === 2 || request.request_type_id === 3">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ml-8 col-6" style="right:-110px; ">
                                    
                                    <div class="d-flex">
                                        <div class="h5">Catégorie : </div> &nbsp;&nbsp;
                                        <div class=""> {{ request.request_category_id }} </div>
                                    </div>
                                    <br>
                                    <div class="d-flex">
                                        <div class="h5">Transmis pour : </div> &nbsp;&nbsp;
                                        <div class=""> {{ request.trans_mention_id }} </div>
                                    </div>
                                </div>
                            </div>
                            <br>
                        ...
                        <div class="d-flex">
                            <div class="col-6">
                                ...
                                <div class="h5">DATE DE RETRAIT PREVUE : {{ request.pw_date }}</div>
                            </div>
            ...
            <div class="d-flex">
                ...
                <div class="text-center col-4" v-if="(user.grade_id === 5) && request.sH_approval === null && request.token !== null">
                    <form @submit.prevent="approve(request)">
                ...
                <div class="text-right col-4" v-if="(user.grade_id === 5) && request.sH_approval === null && request.token !== null">
                ...
                <div class="text-center col-4" v-if="(user.grade_id === 4) && request.rA_approval === null && request.sH_approval !== null && request.token !== null && request.rA_treatment !== null">
                    <form @submit.prevent="approve(request)">
                        <button as="button" type="submit" class="btn btn-primary text-white" style="letter-spacing: 0.1em; border-radius:20px; border:none" role="button">
                             Tranférer
                        </button>
                ...
                <div class="text-center col-4" v-if="(user.grade_id === 4) && request.rA_approval === null && request.deliv_or === null && request.sH_approval !== null && request.token !== null && request.rA_treatment === null">
                    <form  @submit.prevent="showDelivery(request)" >
                        <button as="button" type="submit" class="btn btn-warning text-white" style="letter-spacing: 0.1em; border-radius:20px; border:none" role="button">
                ...
                <div class="text-right col-4" v-if="(user.grade_id === 4) && request.rA_approval === null && request.sH_approval !== null && request.token !== null">
                    <button as="button" type="submit"  @click="openModal" class="btn btn-danger text-white text-right" role="button" style="letter-spacing: 0.1em; border-radius:20px; border:none">
                        Rejeter
                    </button>
                </div>

                <div class="text-center col-4" v-if="(user.grade_id === 3) && request.rA_approval !== null && request.sH_approval !== null && request.dPal_approval === null && request.token !== null">
                    <form @submit.prevent="approve(request)">
                        <button as="button" type="submit" class="btn btn-primary text-white" style="letter-spacing: 0.1em; border-radius:20px; border:none" role="button">
                                Approuver
                        </button>
                ...
                <div class="text-right col-4" v-if="(user.grade_id === 3) && request.rA_approval !== null && request.sH_approval !== null && request.dPal_approval === null && request.token !== null">
                    <button as="button" type="submit"  @click="openModal" class="btn btn-danger text-white text-right" role="button" style="letter-spacing: 0.1em; border-radius:20px; border:none">
                        Rejeter
                    </button>
                </div>

                <div class="text-center col-4" v-if="(user.grade_id === 2) && request.rA_approval !== null && request.sH_approval !== null && request.dPal_approval !== null && request.cDL_approval === null && request.estimated_amount < 70000000 && request.token !== null">
                    <form @submit.prevent="approve(request)">
                        <button as="button" type="submit" class="btn btn-primary text-white" style="letter-spacing: 0.1em; border-radius:20px; border:none" role="button">
                                Approuver
                        </button>
                ...
                <div class="text-right col-4" v-if="(user.grade_id === 2) && request.rA_approval !== null && request.sH_approval !== null && request.dPal_approval !== null && request.cDL_approval === null && request.estimated_amount < 70000000 && request.token !== null">
                    <button as="button" type="submit"  @click="openModal" class="btn btn-danger text-white text-right" role="button" style="letter-spacing: 0.1em; border-radius:20px; border:none">
                        Rejeter
                    </button>
                </div>

                <div class="text-center col-4" v-if="(user.grade_id === 7) && request.rA_approval !== null && request.sH_approval !== null && request.dPal_approval !== null && request.cDL_approval !== null && request.token !== null && request.wh_chief_approval === null && request.wh_treatment !== null">
                    <form @submit.prevent="transRequest(request)">
                        <button as="button" type="submit" class="btn btn-primary text-white" style="letter-spacing: 0.1em; border-radius:20px; border:none" role="button">
                            Tranférer au CM
                        </button>
                    </form>
                ...
                <div class="text-center col-4" v-if="(user.grade_id === 7) && request.rA_approval !== null && request.sH_approval !== null && request.dPal_approval !== null && request.cDL_approval !== null && request.token !== null && request.wh_chief_approval !== null && request.wh_treatment !== null && request.wh_backup == 0 && request.cm_approval !== null">
                    <!-- <form @submit.prevent="approve(request)"> -->
                        <a as="button" type="submit" :href="route('user.request.backup', request)" class="btn btn-primary text-white" style="letter-spacing: 0.1em; border-radius:20px; border:none" role="button">
                            Remonter niveau de stock
                        </a>
                    <!-- </form> -->
                </div>
                <div class="text-center col-4" v-if="(user.grade_id === 7) && request.rA_approval !== null && request.deliv_or == 0 && request.sH_approval !== null && request.dPal_approval !== null && request.cDL_approval !== null && request.token !== null  && request.wh_chief_approval === null && request.wh_treatment === null">
                    <form  @submit.prevent="showDelivery(request)" >
                        <button as="button" type="submit" class="btn btn-warning text-white" style="letter-spacing: 0.1em; border-radius:20px; border:none" role="button">
                ...
                <div class="text-center col-8" v-if="(user.grade_id === 8) && request.rA_approval !== null && request.sH_approval !== null && request.dPal_approval !== null && request.cDL_approval !== null && request.token !== null && request.wh_chief_approval !== null && request.cm_approval === null && request.cm_treatment !== null">
                    <!-- <form @submit.prevent="approve(request)"> -->
                        <a as="button" :href="route('user.request.backup', request)" type="submit" class="btn btn-primary text-white" style="letter-spacing: 0.1em; border-radius:20px; border:none" role="button">
                            Tranférer
                        </a>
                    <!-- </form> -->
                </div>
                <div class="text-center col-4" v-if="(user.grade_id === 8) && request.rA_approval !== null && request.deliv_or == 0 && request.sH_approval !== null && request.dPal_approval !== null && request.cDL_approval !== null && request.token !== null && request.wh_chief_approval !== null && request.cm_approval === null && request.cm_treatment === null">
                    <form  @submit.prevent="showDelivery(request)" >
                        <button as="button" type="submit" class="btn btn-warning text-white" style="letter-spacing: 0.1em; border-radius:20px; border:none" role="button">
                ...
                <div class="text-center col-4" v-if="(user.grade_id === 9) && request.rA_approval !== null && request.sH_approval !== null && request.dPal_approval !== null && request.cDL_approval !== null && request.token !== null && request.wh_chief_approval !== null && request.cm_approval !== null && request.taker_sign === null">
                    <!-- <form @submit.prevent="approve(request)"> -->
                        <button as="button" type="submit" @click="transRequest" class="btn btn-primary text-white" style="letter-spacing: 0.1em; border-radius:20px; border:none" role="button">
                            Signer
                        </button>
                    <!-- </form> -->
                </div>
            
                <div class="text-center col-4" v-if="(user.grade_id === 10) && request.rA_approval !== null && request.sH_approval !== null && request.dPal_approval !== null && request.cDL_approval !== null && request.token !== null && request.wh_chief_approval !== null && request.cm_approval !== null && request.taker_sign !== null && request.prmp_approval === null && request.prmp_treatment !== null">
                    <!-- <form @submit.prevent="approve(request)"> -->
                        <button as="button" type="submit" @click="transRequest" class="btn btn-primary text-white" style="letter-spacing: 0.1em; border-radius:20px; border:none" role="button">
                            Tranférer
                        </button>
                        ...
                        <div class="card card-primary">
                            <form @submit.prevent="formSubmit" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="wHBackPoint" class="h5">Note<span class="text-red">*</span></label>
                                        <textarea rows="4"  class="form-control" id="custom_text" v-model="form.wHBackPoint" autocomplete="on" placeholder="Veuillez renseigner les informations sur l'état du stock" minlength="10" maxlength="600"></textarea>
                                    </div>
                                    <div class="invalid-feedback mb-3" :class="{ 'd-block' : form.errors.wHBackPoint}">
                                        {{ form.errors.wHBackPoint }}
                                    </div>
                                    <div class="form-group">
                                        <label for="backup_file" class="h5">Fichier<span class="text-red">*</span></label>
                                        <input type="file" class="form-control" id="backup_file" @change="onChange"  placeholder="Fichier Pdf" ref="backup_file" :class="{ 'is-invalid' : form.errors.backup_file }">

                                        <div class="invalid-feedback mb-3" :class="{ 'd-block' : form.errors.backup_file }">
                                            {{ form.errors.backup_file }}
                                        </div>
                                    </div>
                            ...
                            <div class="uploader"
                                ...
                                <div v-show="!images.length">
                                    ...
                                    <div class="file-input">
                                        ...
                                        <!-- <input type="hidden" v-model="form.user_grade">
                                        <input type="hidden" v-model="form.request_id"> -->
                                        <input type="file" id="file" @change="onChange" ref="imageSign">
                                    </div>
                                </div>
        ...
        <div class="modal fade" id="modal-commandNAdd">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body overflow-hidden">
                        <div class="card card-primary">
                            <form @submit.prevent="transRequest">
                                <div class="card-body">
                                    <input type="hidden" v-model="form.request_id">
                                    <input type="hidden" v-model="form.author_id">
                                ...
                                <div class="modal-footer justify-content-between">
                                    <button type="button" class="btn btn-danger" style="letter-spacing: 0.1em; background-color: var(--bs-gray); border-radius:20px; border:none" @click="closeModal">Annuler</button>
                                    <button type="submit" class="btn btn-info btn-style text-white" style="letter-spacing:0.1em; background-color:#4851ec; border-radius:20px;" :disabled="!form.command_number || form.processing">Envoyer</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                form: this.$inertia.form({
                    ...
                    // name: '',
                    // file: document.getElementById("backup_file").val(),
                    // success: '',

                    request_id: this.request.id,
                    author_id: this.user.id,
                    wHBackPoint: '',
                    backup_file: this.$refs.backup_file,
                }),
        ...
        mounted(){
                   var file = this.$refs.backup_file;
                    var images = document.getElementById("backup_file").value;
                    // console.log('app');
                    console.log(images);
                },
        computed: {
        ...
        methods: {
            ...
            reject() {
                $('#modal-reject').modal('hide')
                this.form.post(route('user.requests.reject'), { 
                    preserveScroll: true,
                    onSuccess: ()=> {
                        Swal.fire(
                            'Rejetée !',
            ...
            commandNumberAdd(){
                $('#modal-commandNAdd').modal('hide')
                this.form.post(route('user.requests.addCommandN', this.form), {
                    preserveScroll: true,
                    onSuccess:() => {
                        this.form.reset()
                        this.closeModal()
            ...
            formSubmit(e) {
                ...
                Swal.fire({
                    ...
                    data.set('garde_id', this.user.grade_id);
                    data.set('id', this.request.id);
                    axios.post(this.route('user.requests.approve'), data, config)
                        .then(function (res) {
                    ...
                    this.form.post(this.route('user.requests.approve', this.form.id, this.form), {
                        preserveScroll: true,
                        onSuccess: ()=> {
                            Swal.fire(
                                'Approuvée !',
            ...
            transRequest() {
                    ...
                    cancelButtonColor: '#d33',
                    cancelButtonText: 'Annuler',
                    confirmButtonText: 'Oui, transférée!'
                }).then((result) => {
                    if (result.isConfirmed) {
                        this.form.post(this.route('user.requests.transRequest', this.form.id, this.form), {
                            preserveScroll: true,
                            onSuccess: ()=> {
                                Swal.fire(
                                    'Transférée !',
            ...
            sendAgain() {
                Swal.fire({
                    title: 'Avez-vous apporté toutes les modifications ?',
                    text: "Si oui veuillez confirmer svp",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
