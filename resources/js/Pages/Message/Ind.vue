<template>
  <!-- component -->
       ...
       <div class="container-fluid">
                <div class="form-group col-lg-10, col-md-10 col-sm-10" style="justify-content:center; justify-items:center; content:''">
                    <input type="search" id="" class="form-control"/>
                </div>

            <div class="col-md-4"> 
                <!-- <p>Salut <?= $member->name . ' ' . $member->surname; ?></p> -->
                <input type="text" id="fromUser" value="<?= $member->id; ?>" hidden />
                <div>
                    Envoyer à :
                    <input type="search" placeholder="Rechercher un utilisateur" class="status-media" id="searchbox"> &nbsp; <i class="fa fa-spinner fa-spin" style="display:none;" id="spinner"></i>
